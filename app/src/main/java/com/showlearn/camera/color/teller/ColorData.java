...
class ColorData {
    ...
    String changeFileName(String colorName) {
        ...
        if(MenuActivity.currentLanguage.matches("english"))
        {
            if(fileName.matches("lila"))
            {
                fileName = "lila_eng";
            }
            else if(fileName.matches("manilla"))
            {
                fileName = "manilla_eng";
            }
        }
    ...
    String getColorName(String color) {
        ...
        if(MenuActivity.currentLanguage.matches("english"))
        {
            result = english.changeColorName(col.getName());
        }
